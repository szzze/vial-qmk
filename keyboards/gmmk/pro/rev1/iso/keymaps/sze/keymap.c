/* Copyright 2022 Sze <christoph.claassen@gmail.com>
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        TD(0), KC_A, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,                   KC_PGDN,
        KC_LSFT,    KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT, KC_UP,   KC_END,
        KC_LCTL,    KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, MO(1),KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [1] = LAYOUT(
        _______, KC_NUM_LOCK, KC_PSLS, KC_PAST, KC_PMNS, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,      RESET,
        _______, KC_KP_7, KC_KP_8, KC_KP_9, KC_PPLS, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_MPLY,
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    switch(get_highest_layer(layer_state)) {
        case 1:
            ...
            for(uint8_t i=0; i<ARRAYSIZE(LED_LIST_RGBSETTINGS); i++) {
                rgb_matrix_set_color(LED_LIST_RGBSETTINGS[i], RGB_PINK);
            }
            for(uint8_t i=0; i<ARRAYSIZE(LED_LIST_MEDIA); i++) {
                rgb_matrix_set_color(LED_LIST_MEDIA[i], RGB_PINK);
            }
            break;
        case 2:
            rgb_matrix_set_color(LED_L1, RGB_BLUE);
            break;
        case 3:
